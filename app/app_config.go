...
import (
	_ "echt/x/echt/module"
	echtmoduletypes "echt/x/echt/types"
	"time"
...
var (
	...
	appConfig = appconfig.Compose(&appv1alpha1.Config{
		Modules: []*appv1alpha1.ModuleConfig{
			...
			{
				Name:   echtmoduletypes.ModuleName,
				Config: appconfig.WrapAny(&echtmoduletypes.Module{}),
			},
